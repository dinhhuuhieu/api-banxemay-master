...
namespace API
{
    public class Startup
    {
        ...
        { 
            ...
            services.AddTransient<IChitiethopdongRepository, ChitiethopdongRepository>();
            services.AddTransient<IChitiethopdongBusiness, ChitiethopdongBusiness>();

            services.AddTransient<IHopdongRepository, HopdongRepository>();
            services.AddTransient<IHopdongBusiness, HopdongBusiness>();
            ...
            services.AddTransient<INhasanxuatBusiness, NhasanxuatBusiness>();
